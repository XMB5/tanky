...
/**
 * Gets the current shape of the body, but returns the internal shape list (not
 * a copy)
 */
list_t *body_get_shape_unsafe(body_t *body);
...
/**
 * radian/s, Positive is counterclockwise
 */
